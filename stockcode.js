...
const StockDetail = ({ stockSymbol, goToDashboard, showMessage }) => {
  ...
  const resistanceLevels = [
    parseFloat((latestPrice * (1.02 + Math.random() * 0.01)).toFixed(2)), // Slightly above current
    parseFloat((latestPrice * (1.05 + Math.random() * 0.01)).toFixed(2)), // 5% higher
    parseFloat((latestPrice * (1.10 + Math.random() * 0.01)).toFixed(2)), // 10% higher
    parseFloat((latestPrice * (1.15 + Math.random() * 0.01)).toFixed(2)), // 15% higher
    parseFloat((latestPrice * (1.20 + Math.random() * 0.01)).toFixed(2)), // 20% higher
  ];
